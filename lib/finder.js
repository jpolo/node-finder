...
NameFilter._toRegExp = function (stringOrRegexp) {
    if (typeof(stringOrRegexp) !== 'string' && !(stringOrRegexp instanceof RegExp)) {
...
Finder.prototype._postFilter = function (file) {
    ...
    if (!this._nameList.match(filePathBase)) {
        return false;
    }
