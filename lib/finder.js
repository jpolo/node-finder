...
Finder.prototype.reset = function () {
    ...
    this._nameList = new NameList(NameList.MODE_ALL);
    this._namesNot = [];
...
Finder.prototype.notNames = function () {
    ...
    patterns.forEach(function (pattern) {
        ...
        thisFinder._namesNot.push(NameList._toRegexp(pattern));
    });
    return this;
};
...
Finder.prototype.exclude = function () {
    ...
    patterns.forEach(function (pattern) {
        ...
        thisFinder._excludes.push(NameList._toRegexp(pattern));
    });
    return this;
};
...
Finder.prototype._postFilter = function (file) {
    ...
    if (!this._nameList.matches(filePathBase)) {
        return false;
    }
