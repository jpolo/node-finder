...
Finder.MODE_ALL = false;
Finder.MODE_ANY = true;
...
Finder.prototype.reset = function () {
    ...
    this._nameMatchMode = Finder.MODE_ALL;
...
/**
 * Sets the match mode to make desired paths needing to match either any or all names.
 *
 * @param {boolean} type Finder.MODE_ALL|Finder.MODE_ANY
 * @return this
 */
Finder.prototype.nameMatchMode = function (mode) {
    this._nameMatchMode = !!mode;
    return this;
};
...
Finder.prototype._postFilter = function (file) {
    ...
    if (this._nameMatchMode === Finder.MODE_ALL) {
       if (!_matchAllPatterns(filePathBase, this._names)) {
           return false;
       }
    } else {
       if (!_matchAnyPattern(filePathBase, this._names)) {
           return false;
       }
    }
